...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Landroid/support/v4/view/ViewPager;->s:Landroid/os/Parcelable;

    iput-object v3, p0, Landroid/support/v4/view/ViewPager;->t:Ljava/lang/ClassLoader;
    ...
    iput-boolean v2, p0, Landroid/support/v4/view/ViewPager;->ag:Z
    ...
    iput v0, p0, Landroid/support/v4/view/ViewPager;->aw:I
...
.method private a(Landroid/view/View;)Landroid/support/v4/view/aC;
    .locals 4
...
.method private a(IIII)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->c(I)Landroid/support/v4/view/aC;
...
.method private a(IZIZ)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->c(I)Landroid/support/v4/view/aC;
...
.method private a(Landroid/support/v4/view/aC;ILandroid/support/v4/view/aC;)V
    ...
    iget v2, p3, Landroid/support/v4/view/aC;->e:F

    iget v3, p3, Landroid/support/v4/view/aC;->d:F
    ...
    :cond_5
    iget v4, v0, Landroid/support/v4/view/aC;->d:F
    ...
    iget-object v8, p0, Landroid/support/v4/view/ViewPager;->p:Landroid/support/v4/view/PagerAdapter;
...
.method private b(II)Landroid/support/v4/view/aC;
    .locals 2
...
.method private b(Landroid/view/View;)Landroid/support/v4/view/aC;
    .locals 2
    ...
    :cond_2
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/aC;
...
.method private b(I)V
    ...
    invoke-direct {v0, v3}, Landroid/support/v4/view/ViewPager;->c(I)Landroid/support/v4/view/aC;
    ...
    invoke-direct {v0, v2, v5}, Landroid/support/v4/view/ViewPager;->b(II)Landroid/support/v4/view/aC;
    ...
    invoke-direct {v0, v9, v2}, Landroid/support/v4/view/ViewPager;->b(II)Landroid/support/v4/view/aC;
    ...
    invoke-direct {v0, v9, v7}, Landroid/support/v4/view/ViewPager;->b(II)Landroid/support/v4/view/aC;
    ...
    invoke-direct {v0, v6}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/aC;
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Landroid/support/v4/view/aC;
    ...
    invoke-direct {v0, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/aC;
...
.method private c(I)Landroid/support/v4/view/aC;
    .locals 3
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->h()Landroid/support/v4/view/aC;
...
.method private h()Landroid/support/v4/view/aC;
    .locals 13
...
.method final a(Landroid/support/v4/view/aE;)V
    .locals 0
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-direct {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/aC;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/aC;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->ae:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-direct {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/aC;
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-direct {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/aC;
...
.method public setAdapter(Landroid/support/v4/view/PagerAdapter;)V
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/view/aF;-><init>(Landroid/support/v4/view/ViewPager;B)V
    ...
    iput-boolean v5, p0, Landroid/support/v4/view/ViewPager;->ag:Z
    ...
    iput-object v6, p0, Landroid/support/v4/view/ViewPager;->s:Landroid/os/Parcelable;

    iput-object v6, p0, Landroid/support/v4/view/ViewPager;->t:Ljava/lang/ClassLoader;
...
.method public setPageTransformer(ZLandroid/support/v4/view/ViewPager$PageTransformer;)V
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->ao:Ljava/lang/reflect/Method;
    ...
    iput-object v4, p0, Landroid/support/v4/view/ViewPager;->ao:Ljava/lang/reflect/Method;
    :try_end_0
    .catch Ljava/lang/NoSuchMethodException; {:try_start_0 .. :try_end_0} :catch_0
