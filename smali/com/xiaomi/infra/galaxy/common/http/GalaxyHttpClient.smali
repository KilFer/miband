...
.method private executeHelper(Lcom/xiaomi/infra/galaxy/common/BasicGalaxyRequest;Ljava/lang/Class;Lcom/xiaomi/infra/galaxy/common/http/ExecutionContext;Lorg/apache/http/client/HttpClient;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v10}, Lcom/xiaomi/infra/galaxy/common/BasicGalaxyRequest;->setParameters(Ljava/util/Map;)V

    invoke-virtual {p1, v11}, Lcom/xiaomi/infra/galaxy/common/BasicGalaxyRequest;->setHeaders(Ljava/util/Map;)V

    :cond_0
    :try_start_0
    invoke-virtual {p3}, Lcom/xiaomi/infra/galaxy/common/http/ExecutionContext;->getSigner()Lcom/xiaomi/infra/galaxy/common/auth/Signer;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {p3}, Lcom/xiaomi/infra/galaxy/common/http/ExecutionContext;->getCredentials()Lcom/xiaomi/infra/galaxy/common/auth/GalaxyCredentials;
    ...
    invoke-interface {v1, p1, v3}, Lcom/xiaomi/infra/galaxy/common/auth/Signer;->sign(Lcom/xiaomi/infra/galaxy/common/BasicGalaxyRequest;Lcom/xiaomi/infra/galaxy/common/auth/GalaxyCredentials;)V
    ...
    :try_start_2
    invoke-direct {p0, v9, v1}, Lcom/xiaomi/infra/galaxy/common/http/GalaxyHttpClient;->pauseExponentially(ILcom/xiaomi/infra/galaxy/common/GalaxyServiceException;)V
    ...
    invoke-direct {p0, v4, v1, v9}, Lcom/xiaomi/infra/galaxy/common/http/GalaxyHttpClient;->shouldRetry(Lorg/apache/http/client/methods/HttpRequestBase;Ljava/lang/Exception;I)Z
    ...
    invoke-direct {v2, v3, v4, v1}, Lcom/xiaomi/infra/galaxy/common/GalaxyClientException;-><init>(Lcom/xiaomi/infra/galaxy/common/constants/ReturnCode;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/xiaomi/infra/galaxy/common/http/GalaxyHttpClient;->resetRequestAfterError(Lcom/xiaomi/infra/galaxy/common/BasicGalaxyRequest;Ljava/lang/Exception;)V
    :try_end_4
