...
{
  private static final String a = "miui.net.IXiaomiAuthService";
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 3:
      label118: paramParcel1.enforceInterface("miui.net.IXiaomiAuthService");
 ...
 * Qualified Name:     miui.net.IXiaomiAuthService.Stub
