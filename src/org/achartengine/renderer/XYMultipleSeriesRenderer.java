...
public class XYMultipleSeriesRenderer extends DefaultRenderer
{
  ...
  public void setChartValuesTextSize(float paramFloat)
  {
    ...
    int i1 = arrayOfSimpleSeriesRenderer.length;
    for (int i2 = 0; i2 < i1; i2++)
      arrayOfSimpleSeriesRenderer[i2].setChartValuesTextSize(paramFloat);
  }
  ...
  public void setDisplayChartValues(boolean paramBoolean)
  {
    ...
    int i1 = arrayOfSimpleSeriesRenderer.length;
    for (int i2 = 0; i2 < i1; i2++)
      arrayOfSimpleSeriesRenderer[i2].setDisplayChartValues(paramBoolean);
  }
