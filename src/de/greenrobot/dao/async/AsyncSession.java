...
public class AsyncSession
{
  ...
  {
    AsyncOperation localAsyncOperation = new AsyncOperation(paramOperationType, this.daoSession.getDao(paramClass), paramObject, paramInt);
  ...
  {
    AsyncOperation localAsyncOperation = new AsyncOperation(paramOperationType, this.daoSession.getDatabase(), paramObject, paramInt);
    this.executor.enqueue(localAsyncOperation);
    return localAsyncOperation;
  }
  ...
  public <E> AsyncOperation deleteInTx(Class<E> paramClass, int paramInt, E[] paramArrayOfE)
  {
    return enqueEntityOperation(AsyncOperation.OperationType.DeleteInTxArray, paramClass, paramArrayOfE, paramInt);
  }
  ...
  public <E> AsyncOperation deleteInTx(Class<E> paramClass, E[] paramArrayOfE)
  {
    return deleteInTx(paramClass, 0, paramArrayOfE);
  }
  ...
  public <E> AsyncOperation insertInTx(Class<E> paramClass, int paramInt, E[] paramArrayOfE)
  {
    return enqueEntityOperation(AsyncOperation.OperationType.InsertInTxArray, paramClass, paramArrayOfE, paramInt);
  }
  ...
  public <E> AsyncOperation insertInTx(Class<E> paramClass, E[] paramArrayOfE)
  {
    return insertInTx(paramClass, 0, paramArrayOfE);
  }
  ...
  public <E> AsyncOperation insertOrReplaceInTx(Class<E> paramClass, int paramInt, E[] paramArrayOfE)
  {
    return enqueEntityOperation(AsyncOperation.OperationType.InsertOrReplaceInTxArray, paramClass, paramArrayOfE, paramInt);
  }
  ...
  public <E> AsyncOperation insertOrReplaceInTx(Class<E> paramClass, E[] paramArrayOfE)
  {
    return insertOrReplaceInTx(paramClass, 0, paramArrayOfE);
  }
  ...
  public <E> AsyncOperation updateInTx(Class<E> paramClass, int paramInt, E[] paramArrayOfE)
  {
    return enqueEntityOperation(AsyncOperation.OperationType.UpdateInTxArray, paramClass, paramArrayOfE, paramInt);
  }
  ...
  public <E> AsyncOperation updateInTx(Class<E> paramClass, E[] paramArrayOfE)
  {
    return updateInTx(paramClass, 0, paramArrayOfE);
  }
 ...
 * Qualified Name:     de.greenrobot.dao.async.AsyncSession
