    ...
    do
    {
      ...
      while (true)
        if (i < k)
        {
          ...
          try
          {
            CursorFieldHelper.c(localField.getType()).invoke(localField, this, paramCursor, n);
            i++;
          }
  ...
  public ContentValues convertTo()
  {
    ...
    while (true)
      if (j < i)
      {
        ...
        try
        {
          CursorFieldHelper.b(localField.getType()).invoke(localField, this, localContentValues);
          j++;
        }
        catch (Exception localException)
        {
