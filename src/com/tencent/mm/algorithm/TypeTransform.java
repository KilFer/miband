...
public final class TypeTransform
{
  ...
  {
    return (0xFF & paramArrayOfByte[paramInt]) << 56 | (0xFF & paramArrayOfByte[(paramInt + 1)]) << 48 | (0xFF & paramArrayOfByte[(paramInt + 2)]) << 40 | (0xFF & paramArrayOfByte[(paramInt + 3)]) << 32 | (0xFF & paramArrayOfByte[(paramInt + 4)]) << 24 | (0xFF & paramArrayOfByte[(paramInt + 5)]) << 16 | (0xFF & paramArrayOfByte[(paramInt + 6)]) << 8 | 0xFF & paramArrayOfByte[(paramInt + 7)];
  }
  ...
  {
    return (0xFF & paramArrayOfByte[(paramInt + 7)]) << 56 | (0xFF & paramArrayOfByte[(paramInt + 6)]) << 48 | (0xFF & paramArrayOfByte[5]) << 40 | (0xFF & paramArrayOfByte[(paramInt + 4)]) << 32 | (0xFF & paramArrayOfByte[(paramInt + 3)]) << 24 | (0xFF & paramArrayOfByte[(paramInt + 2)]) << 16 | (0xFF & paramArrayOfByte[(paramInt + 1)]) << 8 | 0xFF & paramArrayOfByte[paramInt];
  }
  ...
  public static byte[] intToByteArrayLH(int paramInt)
  {
    ...
    for (int i = 0; i < 4; i++)
      arrayOfByte[i] = ((byte)(paramInt >> (i << 3)));
    return arrayOfByte;
  }
  ...
  public static byte[] longToByteArrayLH(long paramLong)
  {
    ...
    for (int i = 0; i < 8; i++)
      arrayOfByte[i] = ((byte)(int)(paramLong >> (i << 3)));
    return arrayOfByte;
  }
}
