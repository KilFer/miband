...
public class QzoneShare extends BaseApi
{
  ...
  {
    c.a("openSDK_LOG", "fillShareToQQParams() --start");
    ...
    c.a("openSDK_LOG", "fillShareToQQParams() --end");
  ...
  private void a(Context paramContext, Bundle paramBundle, IUiListener paramIUiListener)
  {
    ...
    if (localObject != null)
      ((IUiListener)localObject).onCancel();
    c.a("openSDK_LOG", "shareToH5Qzone() --start");
  ...
  public void shareToQzone(Activity paramActivity, Bundle paramBundle, IUiListener paramIUiListener)
  {
    ...
    while (true)
    {
      ...
      c.a("openSDK_LOG", "shareToQzone() sdcard is null--end");
      return;
      if (str4.length() <= 20)
        break;
      ...
      c.a("openSDK_LOG", "shareToQzone() error--end暂不支持纯图片分享到空间，建议使用图文分享");
      return;
      str1 = "来自" + str4 + "的分享";
      this.a = true;
    }
    label306: if (this.a)
    {
      if (TextUtils.isEmpty(str3))
      {
        ...
        c.a("openSDK_LOG", "shareToQzone() targetUrl null error--end");
        return;
      }
      if (!Util.isValidUrl(str3))
      {
        paramIUiListener.onError(new UiError(-5, "targetUrl有误", null));
        c.a("openSDK_LOG", "shareToQzone() targetUrl error--end");
        return;
      }
    }
    if ((this.c) && (Util.isEmpty(str1)))
    {
      ...
      c.a("openSDK_LOG", "shareToQzone() title is null--end");
      return;
    }
    ...
    if ((localArrayList == null) || ((localArrayList != null) && (localArrayList.size() == 0)))
    {
      if (SystemUtils.compareQQVersion(paramActivity, "4.6.0") < 0)
        break label670;
      a.a(paramActivity, localArrayList, new d(this, paramBundle, paramActivity, paramIUiListener));
    }
    while (true)
    {
      c.a("openSDK_LOG", "shareToQzone() --end");
      return;
      ...
      if (localArrayList.size() == 0)
      {
        ...
        c.a("openSDK_LOG", "shareToQzone() MSG_PARAM_IMAGE_URL_FORMAT_ERROR--end");
        return;
      }
      paramBundle.putStringArrayList("imageUrl", localArrayList);
      break;
      label670: if ((SystemUtils.compareQQVersion(paramActivity, "4.2.0") >= 0) && (SystemUtils.compareQQVersion(paramActivity, "4.6.0") < 0))
      {
        ...
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          ...
          if ((i == 5) && (!Util.fileExists(str5)))
          {
            ...
            c.a("openSDK_LOG", "shareToQzone()手Q版本过低，纯图分享不支持网路图片");
            return;
          }
