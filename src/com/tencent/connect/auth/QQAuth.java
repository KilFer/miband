...
public class QQAuth
{
  ...
  public static QQAuth createInstance(String paramString, Context paramContext)
  {
    ...
    c.a("openSDK_LOG", "createInstance() --start");
    if (c == null)
      c = new HashMap();
    try
    {
      ...
      c.a("openSDK_LOG", "createInstance() ,sessionMap.containsKey --end");
      return (QQAuth)c.get(paramString);
    }
    catch (PackageManager.NameNotFoundException localNameNotFoundException)
    {
      c.a("openSDK_LOG", "createInstance() error --end", localNameNotFoundException);
  ...
  {
    c.a("openSDK_LOG", "logout() --start");
    CookieSyncManager.createInstance(paramContext);
    setAccessToken(null, null);
    setOpenId(paramContext, null);
    c.a("openSDK_LOG", "logout() --end");
  }

  public boolean onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    c.c("openSDK_LOG", "onActivityResult() ,resultCode = " + paramInt2);
  ...
  {
    c.a("openSDK_LOG", "setAccessToken(), validTimeInSecond = " + paramString2);
