...
public class OpenConfig
{
  ...
  private String a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 36	com/tencent/utils/OpenConfig:d	Ljava/lang/String;
    //   4: ifnull +116 -> 120
    //   7: new 65	java/lang/StringBuilder
    //   10: dup
    //   11: invokespecial 66	java/lang/StringBuilder:<init>	()V
    //   14: aload_1
    ...
    //   23: aload_0
    //   24: getfield 36	com/tencent/utils/OpenConfig:d	Ljava/lang/String;
    ...
    //   33: astore 16
    //   35: aload_0
    //   36: getfield 34	com/tencent/utils/OpenConfig:c	Landroid/content/Context;
    //   39: aload 16
    //   41: invokevirtual 82	android/content/Context:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   44: astore 17
    //   46: aload 17
    //   48: astore 5
    //   50: new 84	java/io/BufferedReader
    //   53: dup
    //   54: new 86	java/io/InputStreamReader
    //   57: dup
    //   58: aload 5
    //   60: invokespecial 89	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   63: invokespecial 92	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   66: astore 6
    //   68: new 94	java/lang/StringBuffer
    //   71: dup
    //   72: invokespecial 95	java/lang/StringBuffer:<init>	()V
    //   75: astore 7
    //   77: aload 6
    //   79: invokevirtual 98	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   82: astore 12
    //   84: aload 12
    //   86: ifnull +69 -> 155
    //   89: aload 7
    //   91: aload 12
    //   93: invokevirtual 101	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   96: pop
    //   97: goto -20 -> 77
    //   100: astore 10
    //   102: aload 10
    //   104: invokevirtual 104	java/io/IOException:printStackTrace	()V
    //   107: aload 5
    //   109: invokevirtual 109	java/io/InputStream:close	()V
    //   112: aload 6
    //   114: invokevirtual 110	java/io/BufferedReader:close	()V
    //   117: ldc 112
    //   119: areturn
    //   120: aload_1
    //   121: astore 16
    ...
    //   126: astore_2
    //   127: aload_0
    //   128: getfield 34	com/tencent/utils/OpenConfig:c	Landroid/content/Context;
    //   131: invokevirtual 116	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   134: aload_1
    //   135: invokevirtual 122	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   138: astore 4
    //   140: aload 4
    //   142: astore 5
    //   144: goto -94 -> 50
    //   147: astore_3
    //   148: aload_3
    //   149: invokevirtual 104	java/io/IOException:printStackTrace	()V
    //   152: ldc 112
    //   154: areturn
    //   155: aload 7
    //   157: invokevirtual 123	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   160: astore 14
    //   162: aload 5
    //   164: invokevirtual 109	java/io/InputStream:close	()V
    //   167: aload 6
    //   169: invokevirtual 110	java/io/BufferedReader:close	()V
    //   172: aload 14
    //   174: areturn
    //   175: astore 15
    //   177: aload 15
    //   179: invokevirtual 104	java/io/IOException:printStackTrace	()V
    //   182: aload 14
    //   184: areturn
    //   185: astore 11
    //   187: aload 11
    //   189: invokevirtual 104	java/io/IOException:printStackTrace	()V
    //   192: ldc 112
    //   194: areturn
    //   195: astore 8
    //   197: aload 5
    //   199: invokevirtual 109	java/io/InputStream:close	()V
    //   202: aload 6
    //   204: invokevirtual 110	java/io/BufferedReader:close	()V
    //   207: aload 8
    //   209: athrow
    //   210: astore 9
    //   212: aload 9
    //   214: invokevirtual 104	java/io/IOException:printStackTrace	()V
    //   217: goto -10 -> 207
    //
    // Exception table:
    //   from	to	target	type
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    String str1 = "com.tencent.open.config.json";
    String str2 = paramJSONObject.toString();
    try
    {
      if (this.d != null)
        str1 = str1 + "." + this.d;
      OutputStreamWriter localOutputStreamWriter = new OutputStreamWriter(this.c.openFileOutput(str1, 0));
  ...
  private void b()
  {
    ...
    localBundle.putString("sdkv", "2.1");
    localBundle.putString("sdkp", "a");
    new d(this, localBundle).start();
  }
