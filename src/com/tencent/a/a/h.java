...
public class h
{
  ...
  {
    File localFile1 = a(paramLong);
    File[] arrayOfFile = b(localFile1);
    File localFile2;
    if ((arrayOfFile == null) || (arrayOfFile.length == 0))
      localFile2 = new File(localFile1, "1" + j());
    while (true)
    {
      return localFile2;
      a(arrayOfFile);
      localFile2 = arrayOfFile[(-1 + arrayOfFile.length)];
      int n = arrayOfFile.length - e();
      if ((int)localFile2.length() > d())
      {
        int i2 = 1 + f(localFile2);
        localFile2 = new File(localFile1, i2 + j());
        n++;
      }
  ...
  public File a()
  {
    File localFile1 = a(System.currentTimeMillis());
    File[] arrayOfFile = b(localFile1);
    File localFile2;
    if ((arrayOfFile == null) || (arrayOfFile.length == 0))
      localFile2 = new File(localFile1, "1" + j());
