...
public class Albums extends BaseApi
{
  ...
  public void addAlbum(String paramString1, String paramString2, Albums.AlbumSecurity paramAlbumSecurity, String paramString3, String paramString4, IUiListener paramIUiListener)
  {
    ...
    for (String str = Albums.AlbumSecurity.publicToAll.getSecurity(); ; str = paramAlbumSecurity.getSecurity())
    {
