...
public final class d
{
  ...
  private static ArrayList<d.a> g;
  ...
  static
  {
    ...
    e = 25000;
    f = 15000;
    ConnectivityManager localConnectivityManager = (ConnectivityManager)t.b().getSystemService("connectivity");
    if (localConnectivityManager != null)
    {
      ...
      if (localNetworkInfo != null)
      {
        ...
        {
          String str = ((TelephonyManager)t.b().getSystemService("phone")).getSubscriberId();
    ...
    for (int i2 = (int)(Math.max(m, j) + k - l); ; i2 = i1)
    {
      ...
      for (i2 = b; ; i2 = c)
        ...
        do
        {
          ...
          if (i3 >= b)
            i3 = b;
          d.a locala = b(Thread.currentThread().getId());
          if (locala == null)
  ...
  private static d.a a(long paramLong)
  {
    if (g == null)
      g = new ArrayList();
    int i2;
    ...
    synchronized (g)
    {
      ...
      if (g.size() > 20)
      {
        ...
        if (i3 != 0)
        {
          ...
          p = ((d.a)g.get(0)).d;
          if (((d.a)g.get(0)).f > 0L)
            r = (int)(1000 * ((d.a)g.get(0)).e / ((d.a)g.get(0)).f);
          s = r;
      ...
      do
      {
        ...
        do
        {
          if (!localIterator.hasNext())
          {
            ...
            g.add(locala1);
            return locala1;
            if ((((d.a)g.get(i4)).f <= 0L) && (System.currentTimeMillis() - ((d.a)g.get(i4)).b <= 600000L))
              break label511;
            g.remove(i4);
            i6 = 1;
            i7 = i4;
          ...
          locala2 = (d.a)localIterator.next();
          if (0L > 0L)
            h = 0L;
          if (0L < 0L)
            i = 0L;
  ...
  {
    d.a locala1 = b(Thread.currentThread().getId());
    if (locala1 == null)
      return;
  ...
  public static void a(boolean paramBoolean)
  {
    if (!paramBoolean)
      u = 1 + u;
    d.a locala = c(Thread.currentThread().getId());
    if (locala != null);
  }
  ...
  private static d.a b(long paramLong)
  {
    if (g == null)
      return null;
    synchronized (g)
  ...
  private static d.a c(long paramLong)
  {
    if (g != null);
    while (true)
    {
      ...
      synchronized (g)
      {
        ...
        if (i2 < 0)
          return null;
        if (((d.a)g.get(i2)).a == paramLong)
        {
          d.a locala = (d.a)g.remove(i2);
          return locala;
        }
      }
      i2--;
  ...
  public static void c()
  {
    ...
    while (true)
    {
      ...
      l2 = l;
      break label77;
      label173: d.a locala2 = (d.a)localIterator.next();
      if (locala2.c > 0L)
      {
        j += locala2.c;
        i1++;
