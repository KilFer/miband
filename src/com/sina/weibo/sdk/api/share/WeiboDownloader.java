...
public class WeiboDownloader
{
  ...
  public static Dialog createDownloadConfirmDialog(Context paramContext, IWeiboDownloadListener paramIWeiboDownloadListener)
  {
    ...
    return new AlertDialog.Builder(paramContext).setMessage(str2).setTitle(str1).setPositiveButton(str3, new WeiboDownloader.1(paramContext)).setNegativeButton(str4, new WeiboDownloader.2(paramIWeiboDownloadListener)).create();
  }
