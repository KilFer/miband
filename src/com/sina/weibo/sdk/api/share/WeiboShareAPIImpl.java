  ...
  implements IWeiboShareAPI
{
  ...
  private void sendBroadcast(Context paramContext, String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
    ...
    localIntent.putExtra("_weibo_sign", MD5.hexdigest(Utility.getSign(paramContext, str)));
    if (!TextUtils.isEmpty(paramString3))
      localIntent.setPackage(paramString3);
    if (paramBundle != null)
      localIntent.putExtras(paramBundle);
    LogUtil.d("WeiboApiImpl", "intent=" + localIntent + ", extra=" + localIntent.getExtras());
    paramContext.sendBroadcast(localIntent, "com.sina.weibo.permission.WEIBO_SDK_PERMISSION");
  }

  private boolean shareWithWeibo(Activity paramActivity, String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
  ...
  public boolean sendRequest(BaseRequest paramBaseRequest)
  {
    ...
    while (!checkEnvironment(this.mNeedDownloadWeibo))
      return false;
    VersionCheckHandler localVersionCheckHandler = new VersionCheckHandler(this.mWeiboInfo.packageName);
    if (!paramBaseRequest.check(this.mContext, localVersionCheckHandler))
    {
    ...
    return shareWithWeibo((Activity)this.mContext, "com.sina.weibo.sdk.action.ACTION_WEIBO_ACTIVITY", this.mWeiboInfo.packageName, this.mAppKey, localBundle);
  }
